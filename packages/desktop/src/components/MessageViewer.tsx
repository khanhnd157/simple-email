...
function AttachmentChip({ attachment }: { attachment: Attachment }) {
  ...
  return (
    <div className="flex items-center gap-2 rounded-lg border border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-800 px-3 py-2 hover:bg-gray-100 dark:hover:bg-gray-700 transition-colors cursor-pointer group">
      <Paperclip size={14} className="text-gray-400" />
      <div className="min-w-0">
        <p className="truncate text-xs font-medium text-gray-700 dark:text-gray-300">{attachment.filename}</p>
        ...
        <div className="flex items-start gap-3 px-6 pb-4">
          ...
          <div className="flex-1 min-w-0">
            <div className="flex items-center gap-2">
              <span className="text-sm font-semibold text-gray-900 dark:text-gray-100">{senderName}</span>
